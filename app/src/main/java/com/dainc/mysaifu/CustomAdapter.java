...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(com.dainc.mysaifu.R.layout.custom_row_view, null);
            holder.tvtime = (TextView) convertView.findViewById(com.dainc.mysaifu.R.id.tvtime);
            holder.tvphanloai = (TextView) convertView.findViewById(com.dainc.mysaifu.R.id.tvphannhom);
            holder.tvsotien = (TextView) convertView.findViewById(com.dainc.mysaifu.R.id.tvsotien);
            holder.tvtaikhoan = (TextView) convertView.findViewById(com.dainc.mysaifu.R.id.tvtaikhoan);
